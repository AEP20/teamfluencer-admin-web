            ...
            <ul className="relative font-semibold space-y-0.5 p-4 py-0">
              ...
              <li className="nav-item">
                <ul className="flex-col overflow-y-auto">
                  ...
                  <li className="nav-item">
                    <NavLink to="/statistics/hashtag-search" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <li className="nav-item">
                    <NavLink to="/statistics/popular-brands" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <li className="nav-item">
                    <NavLink to="/statistics/most-content-usernames" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                        ...
                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">
                          Çok İçerik Sahibi Profiller
                        </span>
                      </div>
                    </NavLink>
                  </li>
                  <li className="nav-item">
                    <NavLink to="/statistics/tcno-control" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <h2 className="flex justify-center font-extrabold mt-3 mb-2 font-xl">User</h2>
                  <li className="nav-item">
                  ...
                  <h2 className="flex justify-center font-extrabold mt-3 mb-2 font-xl">Brand</h2>
                  <li className="nav-item">
                  ...
                  <h2 className="flex justify-center font-extrabold mt-3 mb-2 font-xl">Campaign</h2>
                  <li className="nav-item">
                    <NavLink to="/campaigns/find-all-campaigns" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                    ...
                    <NavLink to="/campaigns/approved-campaigns" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <h2 className="flex justify-center font-extrabold mt-3 mb-2 font-xl">API Docs</h2>
